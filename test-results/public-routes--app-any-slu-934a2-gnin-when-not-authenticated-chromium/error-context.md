...
- Name: public-routes.spec.ts >> /app/[any-slug]/audit redirects to /signin when not authenticated
- Location: e2e/public-routes.spec.ts:25:5
...
Call log:
  - navigating to "http://localhost:3000/app/foo/audit", waiting until "load"
