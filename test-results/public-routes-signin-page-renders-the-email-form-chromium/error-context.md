...
- Name: public-routes.spec.ts >> signin page renders the email form
- Location: e2e/public-routes.spec.ts:13:5
...
Call log:
  - navigating to "http://localhost:3000/signin", waiting until "load"
